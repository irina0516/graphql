...
type DefiToken {
    ...
    # to wrap native Coin tokens for DeFi trading.
    canWrapCoin: Boolean!
...
type Delegation {
    ...
    # outstandingSCoin represents the amount of sCoin tokens representing
    # the tokenized stake minted and un-repaid on this delegation.
    outstandingSCoin: BigInt!

    # tokenizerAllowedToWithdraw indicates if the stake tokenizer allows the stake
    # to be withdrawn. That means all the sCoin tokens have been repaid and the sCoin
...
type EstimatedRewards {
    # Amount of Coin tokens expected to be staked for the calculation.
    staked: Long!

    # dailyReward represents amount of Coin tokens estimated
    # to be rewarded for staked amount in average per day.
    dailyReward: BigInt!

    # weeklyReward represents amount of Coin tokens estimated
    # to be rewarded for staked amount in average per week.
    weeklyReward: BigInt!

    # monthlyReward represents amount of Coin tokens estimated
    # to be rewarded for staked amount in average per month.
    monthlyReward: BigInt!

    # yearlyReward represents amount of Coin tokens estimated
    ...
    # Total amount of staked Coin tokens used for the calculation in WEI units.
    ...
    # Information about the last sealed epoch of the blockchain.
    # The epoch provides useful information about total Coin supply,
...
type Query {
    ...
    # Total number of accounts active on the blockchain.
    accountsActive:Long!
    ...
    # Get the id of the current epoch of the blockchain.
    currentEpoch:Long!
    ...
    # The last staker id in blockchain.
    lastStakerId: Long!

    # The number of stakers in blockchain.
    stakersNum: Long!
    ...
    # Get price details of the blockchain token for the given target symbols.
    price(to:String!):Price!

    # Get calculated staking rewards for an account or given
    # staking amount in Coin tokens.
    ...
    # by the Uniswap Core contract on blockchain.
