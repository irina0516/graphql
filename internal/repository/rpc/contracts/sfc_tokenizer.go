...
var SfcTokenizerMetaData = &bind.MetaData{
	ABI: "[{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"addr\",\"type\":\"address\"}],\"name\":\"_updateSCoinTokenAddress\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"allowedToWithdrawStake\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"sender\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"}],\"name\":\"checkAllowedToWithdrawStake\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"stakerID\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"amount\",\"type\":\"uint256\"}],\"name\":\"redeemSCoin\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"name\":\"outstandingSCoin\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"sCoinTokenAddress\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"renounceOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[],\"name\":\"initialize\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"owner\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":true,\"inputs\":[],\"name\":\"isOwner\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"payable\":false,\"stateMutability\":\"view\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"toStakerID\",\"type\":\"uint256\"}],\"name\":\"mintSCoin\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"constant\":false,\"inputs\":[{\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"transferOwnership\",\"outputs\":[],\"payable\":false,\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"anonymous\":false,\"inputs\":[{\"indexed\":true,\"internalType\":\"address\",\"name\":\"previousOwner\",\"type\":\"address\"},{\"indexed\":true,\"internalType\":\"address\",\"name\":\"newOwner\",\"type\":\"address\"}],\"name\":\"OwnershipTransferred\",\"type\":\"event\"}]",
}
...
// OutstandingSCoin is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSCoin(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCaller) OutstandingSCoin(opts *bind.CallOpts, arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "outstandingSCoin", arg0, arg1)
...
//
// Solidity: function outstandingSCoin(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerSession) OutstandingSCoin(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSCoin(&_SfcTokenizer.CallOpts, arg0, arg1)
}

// OutstandingSCoin is a free data retrieval call binding the contract method 0x5b04f4c8.
//
// Solidity: function outstandingSCoin(address , uint256 ) view returns(uint256)
func (_SfcTokenizer *SfcTokenizerCallerSession) OutstandingSCoin(arg0 common.Address, arg1 *big.Int) (*big.Int, error) {
	return _SfcTokenizer.Contract.OutstandingSCoin(&_SfcTokenizer.CallOpts, arg0, arg1)
}
...
// SCoinTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sCoinTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCaller) SCoinTokenAddress(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _SfcTokenizer.contract.Call(opts, &out, "sCoinTokenAddress")
...
//
// Solidity: function sCoinTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerSession) SCoinTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SCoinTokenAddress(&_SfcTokenizer.CallOpts)
}

// SCoinTokenAddress is a free data retrieval call binding the contract method 0x693c5e24.
//
// Solidity: function sCoinTokenAddress() view returns(address)
func (_SfcTokenizer *SfcTokenizerCallerSession) SCoinTokenAddress() (common.Address, error) {
	return _SfcTokenizer.Contract.SCoinTokenAddress(&_SfcTokenizer.CallOpts)
}

// UpdateSCoinTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSCoinTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) UpdateSCoinTokenAddress(opts *bind.TransactOpts, addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "_updateSCoinTokenAddress", addr)
}

// UpdateSCoinTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSCoinTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerSession) UpdateSCoinTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSCoinTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}

// UpdateSCoinTokenAddress is a paid mutator transaction binding the contract method 0x06f03e22.
//
// Solidity: function _updateSCoinTokenAddress(address addr) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) UpdateSCoinTokenAddress(addr common.Address) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.UpdateSCoinTokenAddress(&_SfcTokenizer.TransactOpts, addr)
}
...
// MintSCoin is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSCoin(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) MintSCoin(opts *bind.TransactOpts, toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "mintSCoin", toStakerID)
}

// MintSCoin is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSCoin(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerSession) MintSCoin(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSCoin(&_SfcTokenizer.TransactOpts, toStakerID)
}

// MintSCoin is a paid mutator transaction binding the contract method 0xca2d6fd8.
//
// Solidity: function mintSCoin(uint256 toStakerID) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) MintSCoin(toStakerID *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.MintSCoin(&_SfcTokenizer.TransactOpts, toStakerID)
}

// RedeemSCoin is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSCoin(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactor) RedeemSCoin(opts *bind.TransactOpts, stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.contract.Transact(opts, "redeemSCoin", stakerID, amount)
}

// RedeemSCoin is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSCoin(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerSession) RedeemSCoin(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSCoin(&_SfcTokenizer.TransactOpts, stakerID, amount)
}

// RedeemSCoin is a paid mutator transaction binding the contract method 0x4a37ec9d.
//
// Solidity: function redeemSCoin(uint256 stakerID, uint256 amount) returns()
func (_SfcTokenizer *SfcTokenizerTransactorSession) RedeemSCoin(stakerID *big.Int, amount *big.Int) (*types.Transaction, error) {
	return _SfcTokenizer.Contract.RedeemSCoin(&_SfcTokenizer.TransactOpts, stakerID, amount)
}
