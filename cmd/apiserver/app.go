...
import (
	"flag"
	"galaxy-graphql/cmd/apiserver/build"
	"galaxy-graphql/internal/config"
	"galaxy-graphql/internal/graphql/resolvers"
	"galaxy-graphql/internal/handlers"
	"galaxy-graphql/internal/logger"
	"galaxy-graphql/internal/repository"
	"galaxy-graphql/internal/svc"
	"log"
	"net/http"
	"os"
	"os/signal"
...
func (app *apiServer) run() {
	...
	app.log.Infof("welcome to Galaxy GraphQL API server")
